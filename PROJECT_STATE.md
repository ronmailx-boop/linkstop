...
- [ ] **מסקנה: זו מגבלה אמיתית שלא ניתנת לפתרון בארכיטקטורה הנוכחית** - Supabase Edge Function (Deno) לא יכול להריץ JavaScript של דף אמיתי או לדמות דפדפן. הדרך היחידה לעקוף הגנה כזו היא שירות scraping חיצוני עם דפדפן headless אמיתי (למשל ScrapingBee/Browserless/Scraper API) - שינוי ארכיטקטוני משמעותי (עלות + תלות בשירות צד שלישי), לא "תיקון קטן". **לא בוצע** - ממתין להחלטת המשתמש האם להשקיע בכיוון הזה או לקבל את המגבלה (כמו שהוחלט עבור המקרה החוזר של פייסבוק).
